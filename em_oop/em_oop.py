    ...
    def exp_max_get_max_pos_score(self):
        ...
        for i in range(self.user_iter):
            for j in range(self.len_list):
                ...
                self.max_pos_score = self.exp_max_pos_score_iter(j)
            ...
            self.score_matrix_log_odds = self.exp_max_matrices(i)
